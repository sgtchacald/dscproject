...
_Acréscimo da versão 1.5. Ordem de criação: **13** (após `USUARIOS` e antes de `DESPESAS_USUARIO`). Origem nos documentos `09 - manter-despesa` e `17 - manter-contato`._
