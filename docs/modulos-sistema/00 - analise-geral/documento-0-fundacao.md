...
_Acréscimo da versão 1.5. Ordem de criação: **13** (após `USUARIOS` e antes de `DESPESAS_USUARIO`). Origem nos documentos `2.06 - manter-despesa` e `4.01 - manter-contato`._
...
_Acréscimo da versão 1.7. Ordem de criação: **29** (após `USUARIOS`). Origem no documento `5.01 - manter-usuario`._
