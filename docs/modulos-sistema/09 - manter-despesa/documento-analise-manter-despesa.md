...
| <a id="qdd1-14"></a>14 | VALOR | Tipo: Coluna (moeda, alinhada à direita, com edição inline)<br>Ordenação: Sim | Exibe [C1](#c1).valor (valor desta despesa/parcela) formatado em BRL. Ao dar duplo clique ou clicar no ícone de lápis da célula, permite edição inline rápida via [RT18](#rt18) (visível com [PERM03](#perm03)). |
