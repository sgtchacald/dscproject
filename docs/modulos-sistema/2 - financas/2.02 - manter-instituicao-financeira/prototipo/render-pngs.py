#!/usr/bin/env python3
"""Renderiza os PNGs do documento 2.02 - Manter Instituição Financeira.
...
Saída: ../images/mif-tela-1..5.png, manter-instituicao-financeira-der.png,
       manter-instituicao-financeira-casos-uso.png
"""
import pathlib
...
PROTO = (HERE / "manter-instituicao-financeira-prototipo.html").as_uri()
...
TELAS = [
    ("mif-tela-1.png", "infi-list",   "page"),
    ("mif-tela-2.png", "infi-filtro", "modal"),
    ("mif-tela-3.png", "infi-form",   "modal"),
    ("mif-tela-4.png", "prov-list",   "page"),
    ("mif-tela-5.png", "prov-form",   "modal"),
]
...
def main():
    with sync_playwright() as p:
        ...
        for src, nome in [(DER, "manter-instituicao-financeira-der.png"),
                          (UC, "manter-instituicao-financeira-casos-uso.png")]:
            pg.goto(src)
